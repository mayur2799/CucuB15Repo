...
//		driver = new FirefoxDriver();
	...
	public void he_enters_following_data(DataTable table) throws InterruptedException{
		//Initialize data table 
	      ...
	      driver.findElement(By.id("u_0_j")).sendKeys(data.get(1).get(2));
	      Thread.sleep(2000);
	      System.out.println(data.get(2).get(2));
	      driver.findElement(By.id("u_0_l")).sendKeys(data.get(2).get(2));
	      Thread.sleep(2000);
	      System.out.println(data.get(3).get(2));
	      driver.findElement(By.id("u_0_o")).sendKeys(data.get(3).get(2));
	      Thread.sleep(2000);
